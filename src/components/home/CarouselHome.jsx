...
const CarouselHome = () => {
  ...
  return (
    <div className=" relative w-screen mx-auto mb-[120px] mt-[20px] pt-8">
      ...
      <div className="hidden md:block absolute z-20 left-0 top-0 h-full from-[#ffffff0f] to-[#fff] w-[200px] bg-gradient-to-l  dark:from-[#00000005] dark:to-[#010313]"></div>
      <div className="hidden md:block absolute z-20 right-0 top-0 h-full w-[200px] to-[#fff] from-[#ffffff0f] dark:from-[#00000005] dark:to-[#010313] bg-gradient-to-r "></div>
    </div>
  );
};
