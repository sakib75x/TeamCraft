...
const Faq = ({ isBG }) => {
  const categories = [
    {
      ...
      questions: [
        {
          question: 'How do I create a new project in TeamCraft?',
          answer:
            "After successful Login/Signup navigate to the 'Projects' tab from dashboard and click on 'Create Project', then provide the necessary details and create.",
        },
        {
          question: 'Can I view all existing projects?',
          answer:
            "Yes, after navigate to the 'Projects' section, you can browse all the projects you are in and use filters for more precise searches.",
        },
        {
    ...
    },
    {
      ...
      questions: [
        {
          question: 'How do I invite team members in TeamCraft?',
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer:
            'Yes, TeamCraft supports drag-and-drop functionality, allowing you to organize tasks by workflow in the task board view.',
        },
      ],
    },
    {
      ...
      questions: [
        {
          question: 'What tools can I integrate with TeamCraft?',
          answer:
            'TeamCraft integrates with tools like AI assistant, Docs sharing, Notes, Group chat, Video conferencing and many more to enhance team collaboration.',
        },
        {
          question: 'How can I access all the tools?',
          answer:
            "Under the 'Tools' section you will find all the tools provided by the TeamCraft. But all the tools are not free, you need to be a premium user to access those tools.",
        },
      ],
    },
    {
      ...
      questions: [
        {
          question: 'What subscription plans does TeamCraft offer?',
          answer:
            'TeamCraft offers multiple subscription plans to suit various team sizes and needs, including a Basic, Standard and Premium tiers with additional features.',
        },
        {
          question: 'What payment methods are accepted?',
          answer:
            "TeamCraft accepts major credit cards like MasterCard, Visa for monthly and annual subscriptions. Check the 'Payment' section for full details.",
        },
        {
          question: 'Is my payment information secure?',
          answer:
            'Yes, TeamCraft follows standard  ways to protect your payment details, ensuring your information is kept secure and confidential.',
        },
      ],
    },
  ];
  ...
  return (
    <div>
      <section className={`${isBG && 'bg-white/50 dark:bg-gray-900/50'}   backdrop-blur-lg `}>
                      ...
                      <div key={qIndex} className="mb-8">
                        ...
                        >
                          <div className="flex items-center">
                            ...
                            <h1 className="mx-4 text-lg text-gray-700 dark:text-white">{question.question}</h1>
                          </div>
                        </button>

                        {openQuestion[category.name] === qIndex && (
                          <div className="mt-4 md:mx-10">
                            <p className="max-w-3xl px-4 text-gray-500 dark:text-gray-300">{question.answer}</p>
                          </div>
                        )}
