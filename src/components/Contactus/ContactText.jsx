  ...
  return (
    <div className="mt-5 text-black dark:text-white lg:mt-0" data-aos="slide-left">
      ...
      <div className="flex py-6 gap-5">
        ...
        <p className="mt-4">Meet with a product consultant to see how TeamCraft.net can fit your exact business needs</p>
      </div>
      ...
      <div className="flex py-6 gap-5">
        ...
        <p className="mt-4">Explore our tailored pricing plans based on your goals and priorities</p>
      </div>
      ...
      <div className="flex py-6 gap-5">
        ...
        <p className="mt-4">Boost productivity from day one by building your team&apos;s ideal workflow</p>
      </div>
