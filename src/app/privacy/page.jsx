...
export const metadata = {
    title: 'Privacy Policy | TeamCraft',
    description: 'Learn how we collect, use, and protect your information at TeamCraft.',
}
        ...
        <section className="lg:px-0 bg-white/5 pb-[70px]  px-4 pt-[100px]">
            <div className="container mx-auto py-8 px-4">
                ...
                <section className="mb-6">
                    ...
                    <p className="mb-2">
                        We collect information that you provide to us and that we gather from your usage of TeamCraft. This includes:
                    </p>
                    <ul className="list-disc list-inside mb-2">
                        ...
                        <li><strong>Usage Information:</strong> Information about your interactions with TeamCraft, such as pages visited, features used, and timestamps, to improve user experience.</li>
                        <li><strong>Device Information:</strong> Information about the device and network you use to access TeamCraft, including IP address, browser type, and operating system.</li>
                    </ul>
                </section>
                ...
                <section className="mb-6">
                    ...
                    <p className="mb-2">
                        We use your information to provide, maintain, and enhance TeamCraft, including:
                    </p>
                    <ul className="list-disc list-inside mb-2">
                        ...
                        <li>Sending updates, notifications, and relevant information about TeamCraft</li>
                    </ul>
                </section>
                ...
                <section className="mb-6">
                    ...
                    <ul className="list-disc list-inside mb-2">
                        ...
                        <li><strong>Business Transfers:</strong> In the event of a merger, acquisition, or sale of TeamCraft, user information may be transferred to the new entity.</li>
                    </ul>
                </section>
                ...
                <section className="mb-6">
                    ...
                    <ul className="list-disc list-inside mb-2">
                        <li>Access or update your personal information within your TeamCraft account.</li>
                ...
                <section className="mb-6">
                    ...
                    <p className="mb-2">
                    TeamCraft is not intended for children under 13, and we do not knowingly collect personal information from children under 13.
                    </p>
                </section>
                ...
                <section className="mb-6">
                    ...
                    <p className="mb-2">
                        We may update this Privacy Policy from time to time. We encourage you to review this policy periodically. Continued use of TeamCraft after changes will be deemed acceptance of the updated policy.
                    </p>
                </section>
                ...
                <section className="mb-6">
                    ...
                    <p className="mb-2">
                        If you have any questions or concerns about this Privacy Policy, please contact us at <a href="mailto:your-contact-email@example.com" className="text-blue-500 underline">there will be a mail</a>.
                    </p>
                </section>
            </div>
        </section>
