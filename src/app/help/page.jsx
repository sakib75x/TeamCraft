...
export const metadata = {
  title: "User Manual | TeamCraft",
  description: "Learn how to use TeamCraft with our user manual.",
};
  ...
  const manual = [
    {
      ...
      answer:
        "To create a new project, log in to your TeamCraft account, navigate to the 'Projects' section, and click on 'Create New Project'. Follow the prompts to set up your project details.",
    },
    {
